...
<html>
    <head>
        ...
        <title>ISERVICES - Ativar Login Administrador</title>
            ...
            <div class="content-wrapper" style="background-image:url('./imagens/345349079.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb" style="color:white;">
                        ...
                        <li class="active" style="color: white;">Login Administrador</li>
                    </ol>
<!--                </section>
                <section class="content">-->
                    <form action="./ControleAcessoAdministrador" method="post">
                        <div class="container">
                            ...
                            Ativação de Login Administrador
                        </h1>
                        <small style="color: black;">Administrador ative seu login aqui.</small></center>

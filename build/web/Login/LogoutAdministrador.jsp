...
<html>
    <head>
        ...
        <title>ISERVICES - Logout Administrador</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('../imagens/232581169.jpg');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">

                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> ISERVICES</a></li>
                        <li class="active">Logout Administrador</li>
                    </ol>
                </section>
                <section class="content">
                    <form action="../ControleAcessoAdministrador" method="post">
                        <div class="container">
                            <center><h1 style="color:orangered;">
                            ...
                            <div class="card card-container">
                                ...
                                <input type="email" id="inputEmail" class="form-control" disabled name="txtEmail" value="<%=administrador.getUsuario().getEmail()%>" required autofocus>

...
<html>
    <head>
        ...
        <title>ISERVICES - Nova Profissão</title>
        ...
        <script type="text/javascript" src="../js/categoriaProfissao.js"></script>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            List<CategoriaProfissao> categoriaProfissoes = (List<CategoriaProfissao>) request.getAttribute("novaProfissao");
                ...
                <section class="content">
                    ...
                    <form action="cadastrarProfissao" method="post" > 
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <label for="nome">Categoria da Profissão:</label>
                                    <select class="form-control" name="idcategoria">
                                        <option> Selecione </option>
                                        <%for (CategoriaProfissao cp : categoriaProfissoes) {
                                        %>
                                        <option value="<%=cp.getId()%>"><%=cp.getCategoriaNome()%></option>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" class="form-control" id="categoria" name="txtNomeProfissao" placeholder="Ex. Pedreiro, Eletricista" required>
                                </div>
                                <div class="col-sm-2">
                                    <br/><input  type="submit" class="btn btn-success center-block pull-left"  id="btnSalvar"  value="Salvar">                        
                                </div>
                            </div>
                            <br>
                        </div>

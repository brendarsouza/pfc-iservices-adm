    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li>
                            <a href="Login/NovoAdministrador.jsp">
                        ...
                        <li>
                            <a href="Login/LoginAdministrador.jsp">
            ...
            <div class="content-wrapper">
                ...
                <section class="content" style="background-image: url('imagens/Log.jpg'); background-repeat:no-repeat; background-size:cover; background-position: 100%; text-align: center; padding-top: 70px; padding-bottom: 90px;">
                    <div class="row">
                        <center>
                                ...
                                <a href="Login/LoginAdministrador.jsp">
                                    <div class="container">
                                        ...
                                        <div class="col-sm-6 pull-right">
                                            <p><a href="Login/LoginAdministrador.jsp" style="color:black;"><img src="imagens/login.png" class="w3-hover-opacity" alt="Logar" style="width:100px; height:100px;"> <br/><div class="text">Realizar Login.</div></a> </p>
                                        </div>
                                        <!--</div>-->
                                    </div>
                                </a>

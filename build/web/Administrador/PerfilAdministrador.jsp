...
<html>
    <head>
        ...
        <title>ISERVICES - Área do Administrador</title>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    <h3 style="font-size: 20pt;">Profissões</h3>

                                    <p>Profissões do Sistema</p>
                                    <p><br/></p>
                                </div>
                                <div class="icon">
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="./novaProfissao?idAdm=<%=administrador.getId()%>">Nova Profissao <span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a  href="./consultarTodasProfissoes">Consultar Profissões <span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-xs-6">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3 style="font-size: 20pt;">Categoria de <br/>Profissões</h3>
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="./Categoria/NovaCategoria.jsp">Nova Categoria <span class="pull-right badge bg-orange"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                        <li><a  href="./consultarTodasCategorias">Consultar Categorias <span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-xs-6">
                            ...
                            <div class="small-box bg-olive">
                                <div class="inner">
                                    <h3 style="font-size: 20pt;">Relatórios</h3>
                                ...
                                <div class="box-footer no-padding">
                                    <ul class="nav nav-stacked">
                                        <li><a href="./consultarTodosUsuarios">Relatório de Usuários <span class="pull-right badge bg-blue"><i class="fa fa-arrow-circle-right"></i></span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação de Inativação de Categoria</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        A categoria foi inativada com sucesso!
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="small-box bg-blue">
                            <div class="inner">
                                <h3 style="font-size: 20pt;">Categoria de Profissões</h3>

                                <p>Confira as Categorias em "Consultar Categorias"</p>
                            </div>
                            <div class="icon">
                                <i class="fa fa-tag"></i>

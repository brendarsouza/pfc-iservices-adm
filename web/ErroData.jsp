...
<html>
    <head>
        ...
        <title>ISERVICES - Erro Data de Nascimento</title>
                            ...
                            <div class="col-sm-12">
                                <a href="index.jsp">
                                    <div class="container">
                                        ...
                                        <div class="middle">
                                            <div class="text"><h1 style="color: black;">Erro na data de nascimento! <br/>Por favor, verifique se a data não está no futuro.<br/><a href="index.jsp" style="color: black">Clique aqui e tente novamente!</a></h1></div>
                                        </div>
                                    </div>
                                </a>
                            </div>

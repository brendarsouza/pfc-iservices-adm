    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content" style="background-image: url('imagens/fundo_4.jpg'); background-repeat:no-repeat; background-size:cover; background-position: 100%; text-align: center; padding-top: 70px; padding-bottom: 90px;">
                    <div class="row">
                        <center>
                                ...
                                <a href="Login/LoginAdministrador.jsp">
                                    <div class="container">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <p><a href="Login/LoginAdministrador.jsp" style="color:white;"><br/><div class="text">Realizar Login.</div></a> </p>
                                        </div>
                                        <!--</div>-->
                                    </div>
                                </a>

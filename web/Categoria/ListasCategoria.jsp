...
<html>
    <head>
        ...
        <title>ISERVICES - Listas de Categorias</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            List<CategoriaProfissao> categoriaProfissoes = (List<CategoriaProfissao>) request.getAttribute("categorias");
                                ...
                                <div class="box">
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered" style="text-align: center;">
                                            ...
                                            <% for (CategoriaProfissao categoria : categoriaProfissoes) {%>
                                            <tr>
                                                <td><%=categoria.getId()%></td>
                                                <td><%=categoria.getCategoriaNome()%></td>
                                                <td><%=categoria.getStatusCategoria()%></td>
                                                <td><center><button class="btn btn-success" type="button">
                                                    <a href="./editarCategoria?idEditar=<%= categoria.getId()%>" style="color: white"><i class="fa fa-pencil-square-o img-circle text-default"></i></a>
                                                </button></center></td>

...
<html>
    <head>
        ...
        <title>ISERVICES - Inativar Categoria</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            CategoriaProfissao categoria = (CategoriaProfissao) request.getAttribute("categoria");
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Inativar Categoria</li>
                    </ol>
                </section>
                                    ...
                                    <form action="./editarCategoria" method="post">
                                        ...
                                        <table class="table table-bordered" style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 70px">Código Categoria</th>
                                                <th style="width: auto">Categoria</th>
                                                <th style="width: auto">Status</th>
                                                <th style="width: auto">Salvar</th>
                                            </tr>
                                            <tr>
                                                <td><input type="text" class="form-control" name="txtIdCategoria" value="<%=categoria.getId()%>"/></td>
                                                <td><input type="text" class="form-control" name="txtCategoria" value="<%=categoria.getCategoriaNome()%>"</td>
                                                <td>
                                                    <%
                                                        if (categoria.getStatusCategoria() == Status_Categoria.ATIVO) {
                                                    %>
                                                ...
                                                <td><center><button class="btn btn-success" type="submit">
                                                    <i class="fa fa-pencil-square-o img-circle text-default"> Salvar</i>
                                                </button></center></td>

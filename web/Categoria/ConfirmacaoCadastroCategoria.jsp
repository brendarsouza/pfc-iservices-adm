...
<html>
    <head>
        ...
        <title>ISERVICES - Confirmação de Cadastro de Categoria</title>
                ...
                <section class="content">
                    <form action="../cadastrarCategoria" method="post" > 
                        ...
                        <center>
                            ...
                            <h4>Continue cadastrando Categorias de Profissões.</h4>
                        </center>
                        <br>
                        <div class="row">
                            <div class="col-sm-10">
                                <label for="nome">Nome da Área de Trabalho:</label>
                                <input type="text" class="form-control" id="categoria" name="txtCategoria" placeholder="Ex. TI, Saúde" required>
                            </div>
                            <div class="col-sm-2">
                                <br/>

...
<%@page import="Model.Status_Profissao"%>
<%@page import="Model.Status_Categoria"%>
...
<html>
    <head>
        ...
        <title>ISERVICES - Editar Profissão</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            Profissao profissao = (Profissao) request.getAttribute("editarProfissao");
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Categorias do Sistema</h3>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <form action="./editarProfissao" method="post">

                                        <table class="table table-bordered" style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 70px">Código Profissão</th>
                                                <th style="width: auto">Categoria</th>
                                                <th style="width: auto">Profissão</th>
                                                <th style="width: auto">Status</th>
                                                <th style="width: auto">Salvar</th>
                                            </tr>
                                            <tr>
                                            <input type="text" hidden="" name="txtIdProfissao"  value="<%=profissao.getId()%>"/>
                                            <input type="text" hidden="" name="txtIdCategoria"  value="<%=profissao.getCategoria().getId()%>"/>

                                            <td><%=profissao.getId()%></td>
                                            <td><%=profissao.getCategoria().getCategoriaNome()%></td>
                                            <td><input type="text" class="form-control" name="txtProfissaoNome" value="<%=profissao.getProfissaoNome()%>"</td>

                                            <td><%
                                                if (profissao.getStatusProfissao() == Status_Profissao.ATIVO) {
                                                %>
                                                <select name="txtStatus" id="status" class="btn btn-primary dropdown-toggle" required>
                                                    <option value="">Selecione</option>
                                                    <option value="ATIVO" selected="selected" label="ATIVO">
                                                        Ativo
                                                    </option>
                                                    <option value="INATIVO" label="INATIVO">
                                                        Inativo
                                                    </option>
                                                </select> 
                                                </div>
                                                ...
                                                <select name="txtStatus" id="status" class="btn btn-primary dropdown-toggle" required>
                                                    <option value="">Selecione</option>
                                                    <option value="ATIVO" label="ATIVO">
                                                        Ativo
                                                    </option>
                                                    <option value="INATIVO" selected="selected" label="INATIVO">
                                                        Inativo
                                                    </option>
                                                </select> 
                                                <%
                                                ...
                                                %></td>
                                            <td><center><button class="btn btn-success" type="submit">
                                                    Salvar
                                                </button></center></td>

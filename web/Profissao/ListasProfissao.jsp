...
<html>
    <head>
        ...
        <title>ISERVICES - Listas de Profissões</title>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <%
            ...
            List<Profissao> profissoes = (List<Profissao>) request.getAttribute("profissoes");
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Listagem de Profissões</li>
                    </ol>
                </section>
                                    ...
                                    <div class="box-body">
                                        <table class="table table-bordered" style="text-align: center;">
                                            <tr style="text-align: center;">
                                                <th style="width: 70px">Código Profissao</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><%=profissao.getProfissaoNome() %></td>
                                                <td><%=profissao.getCategoria().getCategoriaNome() %></td>
                                                <td><%=profissao.getStatusProfissao()%></td>
                                                <td><center><button class="btn btn-success" type="button">
                                                    <a href="./editarProfissao?idEditar=<%= profissao.getId()%>" style="color: white"><i class="fa fa-pencil-square-o img-circle text-default"></i></a>
                                                </button></center></td>

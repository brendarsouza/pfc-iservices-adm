...
<html>
    <head>
        ...
        <title>ISERVICES - Cadastro Administrador</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="password" class="form-control" id="senha" name="txtSenha" minlength="6" maxlength="18" placeholder="Senha" required>
                                </div> 
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="name" class="form-control" id="celular" name="txtCelular" required maxlength=13 minlength=13  placeholder="Ex: 00-00000-0000" onKeyPress="formataCelular(this, '##-#####-####')">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <form name="form1">
                                                ...
                                                <input type="text" class="form-control" id="txtCPF" name="txtCPF"  required maxlength=14  minlength=14 placeholder="Ex: 000.000.000-00" onKeyPress="formataCPF(this, '###.###.###-##')"></b>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <input type="name" class="form-control" id="rg" name="txtRG" maxlength=13 placeholder="Ex: 00.000.000-0"  onKeyPress="formataRG(this, '##.###.###-##')" required>
                                </div>
                                <div class="col-sm-4" >
                                    <br>

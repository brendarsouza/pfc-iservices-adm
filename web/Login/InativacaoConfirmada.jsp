...
<html>
    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper" style="background-image:url('imagens/icone.png');background-attachment: fixed;background-position: center center; background-repeat: no-repeat;">
                <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>Inativação Confirmada</h1>
                    <ol class="breadcrumb">

                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown messages-menu" style="padding-top: 5%;">
                                <form action="../perfilAdministrador" method="post"> 
                                    ...
                                    <button type="submit" name="PerfilAdministrador" class="btn btn-warning"><i class="fa fa-home"></i>
                                    </button>
                                </form>
                            </li>
                            <!-- User Account Menu -->
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <center><form action="../perfilAdministrador" method="post"> 
                            <input type="text" name="txtIdAdministrador" value="<%=administrador.getId()%>" hidden>
                            <button type="submit" name="PerfilAdministrador" class="btn btn-md btn-default" style="width: 100%;"><i class="fa fa-home fa-lg"></i></button>
                        </form></center>

                            ...
                            <div class="col-sm-12">
                                <a href="index.jsp">
                                    <div class="container">
                                        ...
                                        <div class="middle">
                                            <div class="text"><h1 style="color: black;">Erro. Dados duplicados! <br/>Por favor, verifique se o e-mail, cpf ou rg são utilizados em outra conta.<br/><a href="index.jsp" style="color: black">Clique aqui e tente novamente!</a></h1></div>
                                        </div>
                                    </div>
                                </a>
                            </div>
